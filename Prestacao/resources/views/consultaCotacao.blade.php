        ...
        <!-- Breadcrumb -->
		  ...
		  <form>
			...
			<div class="columns large-4">  
				...
				<label>
					Valor Un:	
					<input type="text" name="data"  placeholder="Insira o nome" disabled>
				</label><br>
			</div>
			...
			<div class="columns large-4"> 
				...
				<label>
					Quantidade:	
					<input type="text" name="moeda"  placeholder="Insira o nome" disabled>
				</label><br>
				<label>
					Total:	
					<input type="text" name="data"  placeholder="Insira o nome"required disabled>
				</label><br>
			</div>
