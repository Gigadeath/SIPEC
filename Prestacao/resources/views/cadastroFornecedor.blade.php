    <div class="medium-12 large-10 columns" id="main">        
		...
		<form method ="POST" id="altera" action="<?php echo url('prestacao/public/CadFornecedor/update'); ?>">
			<?php echo csrf_field()."<br>";?>
			<div class="expanded row margin-top-20">
				<div class="columns large-4">  
			...
			<div class="expanded row margin-top-20">
				<div class="columns large-4">  
					<button type="submit" id="btnAltera" class="success button">Altera</button>
	...
	$('#btnAltera').on('click', function()
	{
		var verifica=1;
		var contagem;
		$("#altera").ajaxSubmit({url:'<?php echo url('prestacao/public/CadFornecedor/update'); ?>',type:'post',error: function(data) { alert("verifique os dados digitados"); },success: function (data){alert("sucesso"); }});
		location.reload();
	});
	$('#btnCadastra').on('click', function()
	{
		var verifica=1;
		var contagem;
		$("#cadastro").ajaxSubmit({url:'<?php echo url('prestacao/public/CadFornecedor/create'); ?>',type:'post',error: function(data) {  },success: function (data){ }});
		location.reload();
	});
	...
	function edit(id)
	{
		...
		{
			type: 'get',	
			url: '<?php echo url('prestacao/public/ConFornecedor/update');  ?>',
			data: { id: id},
	...
	{	
		...
		{
			type: 'get',	
			url: '<?php echo url('prestacao/public/ConFornecedor/table');  ?>',
		...
		{
			type: 'get',	
			url: '<?php echo url('prestacao/public/ConFornecedor/page');  ?>',
